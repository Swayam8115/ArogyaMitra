...
const DoctorLogin = () => {
    ...
    const onSubmit = async (data) => {
        const success = await loginAsDoctor(data.email, data.password);
        ...
        <div className="min-h-screen bg-gradient-to-br from-violet-50 via-purple-50 to-fuchsia-50 flex items-center justify-center p-4">
            <div className="w-full max-w-md">
                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                    {/* Header band */}
                    <div className="bg-gradient-to-r from-violet-600 to-purple-600 px-8 py-8 text-white text-center">
                        ...
                        <p className="text-white/80 text-sm mt-1">Doctor Portal</p>
                    </div>
                    ...
                    <div className="px-8 py-8 space-y-5">
                        ...
                        <div className="text-center text-sm text-gray-500">
                            ...
                            <Link to="/worker-login" className="font-medium text-violet-600 hover:text-violet-500">
                                Worker Login
                            </Link>
                        </div>
                    </div>
                ...
                <div className="mt-4 flex items-center gap-2 text-xs text-gray-500 justify-center">
                    <Shield size={12} />
                    <span>Secure access for authorized doctors only</span>
                </div>
            </div>
        </div>
    );
